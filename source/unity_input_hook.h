...
/* The exported IL2CPP API Input.touches needs to build a managed Touch[]
 * (il2cpp_array_new, _domain_get, _domain_get_assemblies, _assembly_get_image,
 * _class_from_name, _class_array_element_size). Call before the hooks install. */
...
/* One [time] line: what managed code reads from UnityEngine.Time (called, not
 * hooked) and how often the TimeManager::Update detour ran since the last line. */
...
/* Game tweaks (config.h: SD_ANALYTICS_OFF). */
