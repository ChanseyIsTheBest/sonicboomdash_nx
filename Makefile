#---------------------------------------------------------------------------------
# SONIC DASH 2: SONIC BOOM -- Nintendo Switch homebrew loader (wrapper port)
# Unity 6000.0.72f1 / IL2CPP / arm64-v8a.  Forked from sonicdash_nx (the
# colorsheep_nx / vln_nx so-loader lineage, MIT), with fruitninjaclassic_nx's
# asset pack.  Ships NO game code or assets.
#
...
TARGET      := sonicboomdash
APP_TITLE   := Sonic Dash 2: Sonic Boom
